      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="createuser.php"><button style="background-color : orange">Create a User</button></a>
                    </div>
                  <div class="col-md act">
                    <img src="img/tr.jpg" style="max-width: 55%" class="img-fluid">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : red;">Make a Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/trh.jpg" class="img-fluid">
                    <br>
